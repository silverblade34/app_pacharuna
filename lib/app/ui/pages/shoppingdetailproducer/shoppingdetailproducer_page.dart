...
class ShoppingdetailproducerPage
    extends GetView<ShoppingdetailproducerController> {
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Cliente: ${controller.detailShoppingDto.customer.firstName} ${controller.detailShoppingDto.customer.lastName}',
                    ...
                    const SizedBox(height: 16),
                    if (controller.detailShoppingDto.status ==
                        "solicitado") ...[
                      Row(
                        children: [
                          Expanded(
                            child: InkWell(
                              onTap: () {
                                controller.activePurchase(context);
                              },
                              child: Container(
                          ...
                          Expanded(
                            child: InkWell(
                              onTap: () {
                                controller.rejectPurchase(context);
                              },
                              child: Container(
                                alignment: Alignment.center,
                                height: 45,
                    ...
                    ] else if (controller.detailShoppingDto.status ==
                        "activo") ...[
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: InkWell(
                                        onTap: () {
                                          controller.approvePurchase(context);
                                        },
                                        child: Container(
                                          alignment: Alignment.center,
                                          height: 45,
                                ...
                                child: Center(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Aún no hay un comprobante de pago",
                                        style: TextStyle(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if (controller.detailShoppingDto.vouchers
                                  .comprobante.isEmpty) ...[
                                IconButton(
                          ...
                          if (controller.detailShoppingDto.vouchers.comprobante
                              .isNotEmpty) ...[
                            Wrap(
                              spacing: 10,
                              runSpacing: 10,
                            ...
                            Obx(() {
                              if (controller.imagesComprobante.isEmpty) {
                                return GestureDetector(
                                  child: DottedBorder(
                                    color:
                                ...
                                return Wrap(
                                  ...
                                  runSpacing: 10,
                                  children:
                                      controller.imagesComprobante.map((image) {
                                    return Stack(
                                      children: [
                                        Image.file(
                                          image,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            spacing: 10,
                            runSpacing: 10,
                            children: controller.detailShoppingDto.vouchers.comprobante
                                .map((image) {
                              return GestureDetector(
                                onTap: () {
                                  Navigator.push(
